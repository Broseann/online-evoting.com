    ...
    <div id="row">
		...
		?>
		  ...
		  <div class = "alert alert-info">
			<div class="panel-heading" style="background-color: maroon; border-color: maroon"><center>PRESIDENT</center></div>
			<br />
			<?php
				if(!$_SESSION['pres_id'])
					{
			...
			<div class="panel-heading" style="background-color: maroon; border-color: maroon"><center>VICE PRESIDENT</center></div>
			<br />
			<?php
				if(!$_SESSION['vp_id'])
					{
			...
			<div class = "alert alert-info">
			<div class="panel-heading" style="background-color: maroon; border-color: maroon"><center>SECRETARY</center></div>
			<br/>
			<?php
				if(!$_SESSION['ua_id'])
					{
			...
			<div class = "alert alert-success" >
			<div class="panel-heading" style="background-color: maroon; border-color: maroon"><center>TREASURER</center></div>
			<br />
			<?php
				if(!$_SESSION['ss_id'])
					{
			...
			<div class="panel-heading" style="background-color: maroon; border-color: maroon"><center>AUDITOR</center></div>
			<br />
			<?php
				if(!$_SESSION['ea_id'])
					{
			...
			<div class = "alert alert-success">
			<div class="panel-heading" style="background-color: maroon; border-color: maroon"><center>PUBLIC INFORMATION OFFICER</center></div>
			<br />
			<?php
			...
			<div class = "alert alert-info" >
			<div class="panel-heading" style="background-color: maroon; border-color: maroon"><center>BUSINESS MANAGERS</center></div>
			<br />
			<?php
				if(!$_SESSION['vtr_id'])
					{
			...
			<div class = "alert alert-success">
			<div class="panel-heading" style="background-color: maroon; border-color: maroon"><center>SARGENT AT ARMS</center></div>
			<br />
			<?php
				if(!$_SESSION['sg_id'])
					{
