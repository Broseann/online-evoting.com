...
<body>
	...
	<div class="col-lg-6">
                    ...
                    <div class="panel panel-primary" style="border-color: maroon">
                        <div class="panel-heading" style="background-color: maroon; border-color: maroon" ><center>
                            PRESIDENT</center>
                        </div>
	...
	<div class="col-lg-6">
	 ...
	 <div class="col-lg-6">
	  <div class="panel panel-primary" style="border-color: maroon">
            <div class="panel-heading" style="background-color: maroon; border-color: maroon">
			<center>Public Information Officer</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
					$query = $conn->query("SELECT * FROM `candidate` WHERE `position` = 'Public Information Officer'") or die(mysqli_errno());
					while($fetch = $query->fetch_array())
					{
				?>
						<div id = "position">
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary" style="border-color: maroon">
            <div class="panel-heading" style="background-color: maroon; border-color: maroon">
			<center>Business Managers</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
					$query = $conn->query("SELECT * FROM `candidate` WHERE `position` = 'Business Managers'") or die(mysqli_errno());
					while($fetch = $query->fetch_array())
					{
				?>
						<div id = "position">
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary" style="border-color: maroon">
            <div class="panel-heading" style="background-color: maroon; border-color: maroon">
			<center>Sargent at Arms</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
					$query = $conn->query("SELECT * FROM `candidate` WHERE `position` = 'Sargent at Arms'") or die(mysqli_errno());
					while($fetch = $query->fetch_array())
					{
				?>
						<div id = "position">
